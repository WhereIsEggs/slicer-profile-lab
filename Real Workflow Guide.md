...
New filament copies use clean product names without `@System`/printer suffixes
or the set name. A leading manufacturer name is removed only when it matches
